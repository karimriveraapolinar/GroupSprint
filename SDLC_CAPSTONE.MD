...
**What strict adherence would have looked like:**  It wouldve been more like the Waterfall model in that we move up the stages and never down, we leave them in the past and only progress forward.
